      ...
      <div className="flex md:flex-row px-15 md:px-40 justify-around pt-50 pb-30 flex-wrap-reverse">
        ...
        >
          ...
          <h2 className="text-xl md:text-4xl font-bold flex flex-row flex-wrap items-end gap-2">
            ...
            <div className="h-[1.2em] xl:w-45 leading-tight overflow-hidden">
              ...
              >
                <p className="text-purple-400">FullStack</p>
                <p className="text-red-400">Back-end</p>
                <p className="text-blue-400">Front-end</p>
                <p className="text-purple-400">FullStack</p>
              </motion.div>
            </div>
          </h2>
        ...
        <div className="relative mb-15 md:mb-30">
          <motion.div
            ...
            className="absolute w-full h-35 md:h-50 border border-gray-300 dark:border-gray-800 rounded-full left-10 top-10 z-[-1]"
          ></motion.div>
          <img
            className=" realtive h-35 md:h-50 rounded-full "
            src={perfil}
            alt="Foto de Walker Pontes "
          />
        </div>
      </div>
    </>
